...
const NewFestival = () => {
  ...
  const validateForm = () => {
    if (!date_debut || !date_fin || !heure_debut || !heure_fin || !intervalle ) {
      setNotif(true);
      return false;
    }
    return true;
  ...
  return (
    isExpired || (user && user.role !== 'ADMIN') ? (
      <Navigate to={'/'} />
    ) : (
      <div className="NewFestival">
        ...
        <div className="signup-form-containers">
            ...
            <div className="postes">
                  ...
                  <div className="poste-check">
                    <input
                      ...
                      onClick={(e) =>
                        handlePosteClick(
                          poste.idposte,
                          Number(e.target.nextElementSibling.value)
                        )
                      }
                    />
              ...
              {notif && (
                <div className="notif-error">
                  <MdOutlineCancel className="error-icon" /> Veuillez
                  sélectionner une capacité supérieur à 0
                </div>
              )}
              {notif && (
                <div className="notif-error">
          ...
          <div className="addNewPoste">
            <label className="labels-newPoste bold">
              Nouveau poste (facultatif){' '}
            </label>
            <button
          ...
          <div className="inputs">
            ...
            <input
              type="text"
              name="newPosteDescription"
              id="newPosteDescription"
              value={description}
              onChange={(e) => {
          ...
          {festival ? (
            <div className="notif-succes">
              ...
              <div>
                Festival créé ! Importer le fichier de jeu et espace dès
                maintenant depuis l'accueil du festival
              </div>
            </div>
          ) : (
